...
// Skip_storage is the number of iterations during computation that gets skipped before storing
// values in the final matrix.
// e.g. store every skip_storage-th value in the matrix
extern const int SKIP_STORAGE;
